...
import Register from "./components/Pages/Logout/Register";
import Profile_User from "./components/common/users/Header_Profile/Nav_Profile";
import Home_Profile from "./components/Layouts/Home_Profile/Home_Profile";
import Mannager_Profile from "./components/Layouts/Admin_CV/Mannager_Profile";
import Criteria_Profile from "./components/Layouts/Job_love/Criteria_Profile";
import All_Work from "./components/Pages/Jobs_Search/All_Work";
import Admin_company from "./components/Admin/Creacte_Companys/Admin_company";
import Detail_company from "./components/Pages/Detail_Companys/Detail_company";
import Admin_jobs from "./components/admin_company/Admin_Jobs/Admin_jobs";
import { AuthProvider } from "./components/Admin/AuthContext";
import Information_user from "./components/Admin/Admin_Users/Information_user";
import Admin_cv from "./components/admin_company/Admin_CVs/Admin_cv";
